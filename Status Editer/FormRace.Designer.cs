...
namespace Status_Editer {
	partial class FormRace {
		...
		private void InitializeComponent() {
			...
			this.DataGridViewRace.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.AllCells;
			...
			this.DataGridViewRace.RowTemplate.Height = 21;
			...
			this.lvTPDataGridViewTextBoxColumn.HeaderText = "LvTP";
			...
			this.lvATKDataGridViewTextBoxColumn.HeaderText = "LvATK";
			...
			this.lvDEFDataGridViewTextBoxColumn.HeaderText = "LvDEF";
			...
			this.lvRATDataGridViewTextBoxColumn.HeaderText = "LvRAT";
			...
			this.lvRDFDataGridViewTextBoxColumn.HeaderText = "LvRDF";
			...
			this.lvMATDataGridViewTextBoxColumn.HeaderText = "LvMAT";
			...
			this.lvMDFDataGridViewTextBoxColumn.HeaderText = "LvMDF";
