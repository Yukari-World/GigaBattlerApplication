...
namespace Status_Editer {
	partial class FormArmor {
		...
		private void InitializeComponent() {
			...
			this.armorIDDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.armorNameDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.tablearmorBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.gigaBattlerDataSet = new CommonLibrary.GigaBattlerDataSet();
			this.___table_armorTableAdapter = new CommonLibrary.GigaBattlerDataSetTableAdapters.@__table_armorTableAdapter();
			this.toolStripContainer1.ContentPanel.SuspendLayout();
			this.toolStripContainer1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.DataGridViewArmor)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.tablearmorBindingSource)).BeginInit();
			...
			// 
			this.toolStripContainer1.ContentPanel.Controls.Add(this.DataGridViewArmor);
            ...
            this.armorIDDataGridViewTextBoxColumn,
            this.armorNameDataGridViewTextBoxColumn,
			...
			this.DataGridViewArmor.DataSource = this.tablearmorBindingSource;
			this.DataGridViewArmor.Dock = System.Windows.Forms.DockStyle.Fill;
			this.DataGridViewArmor.Location = new System.Drawing.Point(0, 0);
			this.DataGridViewArmor.Name = "DataGridViewArmor";
			this.DataGridViewArmor.Size = new System.Drawing.Size(1440, 785);
			this.DataGridViewArmor.TabIndex = 0;
			// 
			// armorIDDataGridViewTextBoxColumn
			// 
			this.armorIDDataGridViewTextBoxColumn.DataPropertyName = "ArmorID";
			this.armorIDDataGridViewTextBoxColumn.HeaderText = "ArmorID";
			this.armorIDDataGridViewTextBoxColumn.Name = "armorIDDataGridViewTextBoxColumn";
			// 
			// armorNameDataGridViewTextBoxColumn
			// 
			this.armorNameDataGridViewTextBoxColumn.DataPropertyName = "ArmorName";
			this.armorNameDataGridViewTextBoxColumn.HeaderText = "ArmorName";
			this.armorNameDataGridViewTextBoxColumn.Name = "armorNameDataGridViewTextBoxColumn";
			// 
			...
			// 
			// tablearmorBindingSource
			// 
			this.tablearmorBindingSource.DataMember = "__table_armor";
			this.tablearmorBindingSource.DataSource = this.gigaBattlerDataSet;
			// 
			// gigaBattlerDataSet
			// 
			...
			// 
			// ___table_armorTableAdapter
			// 
			this.___table_armorTableAdapter.ClearBeforeFill = true;
			// 
			// FormArmor
			// 
			...
			this.Name = "FormArmor";
			this.Text = "Armor Table";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormArmor_FormClosed);
			this.Load += new System.EventHandler(this.FormArmor_Load);
			this.toolStripContainer1.ContentPanel.ResumeLayout(false);
			this.toolStripContainer1.ResumeLayout(false);
			this.toolStripContainer1.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.DataGridViewArmor)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.tablearmorBindingSource)).EndInit();
		...
		private DataGridView DataGridViewArmor;
		private GigaBattlerDataSet gigaBattlerDataSet;
		private BindingSource tablearmorBindingSource;
		private CommonLibrary.GigaBattlerDataSetTableAdapters.__table_armorTableAdapter ___table_armorTableAdapter;
		private DataGridViewTextBoxColumn armorIDDataGridViewTextBoxColumn;
		private DataGridViewTextBoxColumn armorNameDataGridViewTextBoxColumn;
